...
export const Footer = () => {
  ...
  return (
    <footer className="bg-background border-t border-white/5 py-12">
      <div className="container mx-auto px-4 md:px-12 flex flex-col md:flex-row items-center justify-between gap-6 md:gap-0">
        ...
        <div className="flex items-center gap-8 text-xs uppercase tracking-widest text-white/60">
          ...
          <a href="#" className="hover:text-white transition-colors">{t('footer_investors')}</a>
        </div>
